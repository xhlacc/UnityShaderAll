...
public class ColorPicker : MonoBehaviour {
	...
	void OnMouseDown() {
        ...
        GameObject tempObj = GameObject.Find("Directional Light");
        if(tempObj != null)
        {
            Quaternion temp = tempObj.transform.localRotation;
            Debug.Log("方向光方向： " + temp.eulerAngles);



            Vector3 temp2 = Vector3.Normalize(new Vector3(temp.x,temp.y,temp.z));
            Debug.Log("方向光方向2： " + temp2);
        }
	}
